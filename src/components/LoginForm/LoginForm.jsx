...
export const LoginForm = () => {
    ...
    const validate = (data) => {
        ...
        if (!data.num_documento) {
            errors.num_documento = 'Dni is required.';
        }
        ...
        <div className="register-form">
            ...
            <div className="flex justify-content-center">
                <div className="card">
                    ...
                    <Form onSubmit={onSubmit} initialValues={{ username: '', num_documento: '', clave: '', fec_nacimiento: '' }} validate={validate} render={({ handleSubmit }) => (
